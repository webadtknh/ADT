...
class Home_Controller extends MY_Controller {
	...
	public function home() {
		...
		//Check if the user is a facility admin performs update
		if ($this -> session -> userdata('user_indicator') == "facility_administrator") {

            //require_once(APPPATH.'controllers/backup.php');
